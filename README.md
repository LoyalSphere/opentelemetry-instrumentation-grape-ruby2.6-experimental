...
## This version of the gem requires the opentelemetry-instrumentation-rack v0.23.4 that was modified to run on Ruby 2.6, versioned v0.22.23.4. This modded gem can be found at https://github.com/LoyalSphere/opentelemetry-instrumentation-rack-ruby2.6-experimental
### Both modded gems must be included in the gemfile in order for the gem dependencies to work.
